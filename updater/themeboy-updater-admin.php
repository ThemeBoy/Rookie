...
class ThemeBoy_Updater_Admin {
	...
	function __construct( $config = array(), $strings = array() ) {
		...
		$config = wp_parse_args( $config, array(
			'remote_api_url' => 'https://account.themeboy.com',
	...
	function updater() {
		...
		if ( !class_exists( 'ThemeBoy_Updater' ) ) {
			// Load our custom theme updater
			include( dirname( __FILE__ ) . '/themeboy-updater-class.php' );
		}

		new ThemeBoy_Updater(
			array(
				...
				<table class="form-table">
					<tbody>
						...
						<tr valign="top">
							...
							<td>
								<input id="<?php echo $this->theme_slug; ?>_license_key" name="<?php echo $this->theme_slug; ?>_license_key" type="text" class="regular-text" value="<?php echo esc_attr( $license ); ?>"<?php if ( ( $license && 'valid' == $status ) ) { echo ' readonly="readonly"'; } ?> />
								<p class="description">
									<?php echo $message; ?>
								</p>
							</td>
	...
	function disable_wporg_request( $r, $url ) {
		...
		if ( 0 !== strpos( $url, 'https://api.wordpress.org/themes/update-check/1.1/' ) ) {
 		...
 		// Remove the active theme from the check
